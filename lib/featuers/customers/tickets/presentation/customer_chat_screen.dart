...
class _CustomerChatScreenState extends State<CustomerChatScreen> {
  ...
  void _extractMessages() {
    ...
    // Main initial ticket message/description (created by customer -> RIGHT side)
  ...
  void _sendMessage() async {
    ...
    // Optimistic UI addition (User on RIGHT side)
    final optimisticMsg = {
      'id': null,
      'message': text,
      'sender': 'You',
    ...
    try {
      if (_activeTicket != null && _activeTicket!['id'] != null) {
        ...
        await _ticketsRx.replyTicket(ticketId, text);
      } else {
        await _ticketsRx.createTicket(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 6.h),
                                Text(
                                  "We're here to help! Send a message below to chat with our Support Team.",
